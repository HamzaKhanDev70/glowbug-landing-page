...
const teamMembers = [
  ...
  },
  {
    ...
    description: [
      ...
      "Zeeshan's technical expertise spans a wide range of areas, including cloud computing, artificial intelligence, machine learning, data analytics, and cybersecurity. He is a thought leader in the industry, known for identifying and leveraging new technologies to solve complex business problems."
    ]
  },
  {
    name: "Mustafa Khan",
  ...
  },
  {
    ...
    description: [
      ...
      "As a telecom expert, Mr. Khan is highly skilled in managing SLA-based operations, ensuring that services are delivered to the highest standards of quality and reliability. He is known for his ability to develop and implement innovative solutions that enhance operational performance and reduce downtime while maximizing customer satisfaction. Mr. Khan's commitment to excellence and extensive experience in the telecom sector make him an invaluable asset to any organization."
    ]
  },
  {
    name: "David Kim",
                ...
                <div className="p-4 text-left ">
                  ...
                  {member.description && (
                    <p className="body-normal-a tracking-wide text-gray-300 text-justify " >
                      {getFirst25Words(member.description[0])}
                      <button
