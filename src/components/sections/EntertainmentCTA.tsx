...
export default function EntertainmentCTA() {
  return (
    <div className="w-full flex flex-col items-center py-12 md:py-10 text-center">
      <h1 className=" text-[3rem] sm:text-[5rem] md:text-[6rem] lg:text-[8rem] mb-12 md:mb-20 whitespace-nowrap"  style={{ fontFamily: '"Right Grotesk Tight", sans-serif' }}>
