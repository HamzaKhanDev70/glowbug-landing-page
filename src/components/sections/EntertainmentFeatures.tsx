const features = [
  {
    icon: (
      ...
      >
        <path
          d="M36 12H12C9.79086 12 8 13.7909 8 16V32C8 34.2091 9.79086 36 12 36H36C38.2091 36 40 34.2091 40 32V16C40 13.7909 38.2091 12 36 12ZM12 32V16H36V32H12Z"
          fill="#FFD700"
        />
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M36 12H12C10.4087 12 8.88258 12.6321 7.75736 13.7574C6.63214 14.8826 6 16.4087 6 18V30C6 31.5913 6.63214 33.1174 7.75736 34.2426C8.88258 35.3679 10.4087 36 12 36H36C37.5913 36 39.1174 35.3679 40.2426 34.2426C41.3679 33.1174 42 31.5913 42 30V18C42 16.4087 41.3679 14.8826 40.2426 13.7574C39.1174 12.6321 37.5913 12 36 12Z"
          stroke="#FFD700"
          strokeWidth="2"
        />
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M24 12L28 20.5L37 22L30.5 28.5L32 37L24 33L16 37L17.5 28.5L11 22L20 20.5L24 12Z"
          fill="#FFD700"
        />
      </svg>
    ),
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M35 16H13C11.8954 16 11 16.8954 11 18V30C11 31.1046 11.8954 32 13 32H35C36.1046 32 37 31.1046 37 30V18C37 16.8954 36.1046 16 35 16Z"
          stroke="#FFD700"
          strokeWidth="2"
        />
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M40 24L24 12L8 24M35 22V36H13V22"
          stroke="#FFD700"
          strokeWidth="2"
        />
      </svg>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="heading-m lg:heading-l text-white font-bold mb-2 sm:mb-4">
                {feature.title}
              </h3>
